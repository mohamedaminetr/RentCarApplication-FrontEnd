...
export class ClientsComponent {
  ...
  allClients: Client[] = [
    { initials: 'KA', name: 'Karim Ayari',    email: 'k.ayari@email.com',    phone: '+216 55 123 456', rentals: 14, totalSpent: 3240, status: 'vip',      avatarClass: 'av-gold'   },
    { initials: 'SB', name: 'Sonia Ben Ali',  email: 'sonia.ba@email.com',   phone: '+216 98 765 432', rentals: 9,  totalSpent: 2180, status: 'active',   avatarClass: 'av-teal'   },
    { initials: 'MH', name: 'Mohamed Hamdi',  email: 'm.hamdi@email.com',    phone: '+216 22 334 556', rentals: 6,  totalSpent: 1560, status: 'active',   avatarClass: 'av-blue'   },
    { initials: 'LT', name: 'Leila Trabelsi', email: 'l.trabelsi@email.com', phone: '+216 71 889 900', rentals: 21, totalSpent: 5840, status: 'vip',      avatarClass: 'av-purple' },
    { initials: 'RB', name: 'Rami Bchir',     email: 'r.bchir@email.com',    phone: '+216 50 112 233', rentals: 2,  totalSpent: 380,  status: 'inactive', avatarClass: 'av-red'    },
    { initials: 'NA', name: 'Nour Aouadi',    email: 'n.aouadi@email.com',   phone: '+216 93 441 220', rentals: 11, totalSpent: 2990, status: 'vip',      avatarClass: 'av-gold'   },
  ];
