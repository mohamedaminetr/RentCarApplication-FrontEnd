...
export class HomeComponent {
  ...
  quickActions = [
    { label: 'New',      title: 'Add Booking', route: '/bookings/new',
    ...
    { label: 'Fleet',    title: 'Add Vehicle', route: '/fleet/new',
    ...
    { label: 'Client',   title: 'Add Client',  route: '/clients/new',
    ...
    { label: 'Reports',  title: 'Analytics',   route: '/analytics',
    ...
    { label: 'Schedule', title: 'Calendar',    route: '/calendar',
    ...
    { label: 'System',   title: 'Settings',    route: '/settings',
